...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(59.919055, 30.3813694)],
		[new google.maps.LatLng(20.700055, 30.5513694)],
		[new google.maps.LatLng(33.809055, 30.5813694)],
		[new google.maps.LatLng(18.859055, 30.5013694)],
	]
	var options = {
		zoom: 10,
		panControl: false,
...
let bannerBtn = document.querySelectorAll('.banner__link');
// let bannerBtnActive = document.querySelector('.banner__link-left');
for(let i=0; i<bannerBtn.length;i++){
  bannerBtn[i].addEventListener('mouseover', function(e) {
  this.classList.toggle('active');
  this.addEventListener('mouseout', e => {this.classList.remove('active')})
});}


let cardBtn = document.querySelectorAll('.card__link');
// let bannerBtnActive = document.querySelector('.banner__link-left');
for(let i=0; i<cardBtn.length;i++){
  cardBtn[i].addEventListener('mouseover', function(e) {
  this.classList.toggle('active');
  this.addEventListener('mouseout', e => {this.classList.remove('active')})
});}
